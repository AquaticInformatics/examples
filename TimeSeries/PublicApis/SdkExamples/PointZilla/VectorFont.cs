...
namespace PointZilla
{
    ...
    public class VectorFont
    {
        public class Symbol
        {
            ...
            public IReadOnlyList<Line> Lines => RenderLines();
            ...
            private IReadOnlyList<Line> RenderLines()
            {
                if (_lines != null)
                    return _lines;
                ...
                void LineTo(Point point)
                {
                    ...
                    if (penPosition.X == point.X && penPosition.Y == point.Y)
                        return;

                    lines.Add(new Line(penPosition, point));
        ...
        // TODO: Support more than the Simplex font subset
