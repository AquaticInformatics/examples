...
namespace NWFWMDLabFileImporter
{
    public class Importer
    {
        ...
        private List<SamplingLocation> Locations { get; set; }
        private List<ObservedProperty> ObservedProperties { get; set; }
        ...
        {
            var observations = new LabFileLoader(Log, Context, AnalysisMethods, Locations, ObservedProperties, Units)
                .Load(path)
                .ToList();
